  ...
  return (
    <div className="flex justify-start items-center">
      ...
      >
        ...
        className={editor.isActive("heading", { level: 4 }) ? "bg-wh-500 text-wh-50 p-1 rounded-md" : "p-1"}
      >
        h4
      </button>
      <button
        ...
        className={editor.isActive("heading", { level: 5 }) ? "bg-wh-500 text-wh-50 p-1 rounded-md" : "p-1"}
      >
        h5
      </button>
      <button
        ...
        className={editor.isActive("heading", { level: 6 }) ? "bg-wh-500 text-wh-50 p-1 rounded-md" : "p-1"}
      >
        h6
      </button>
      <button
